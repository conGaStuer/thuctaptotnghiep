<head>
    <style>
        ...
        .btn-submit:disabled {
            ...
            /* Màu xám cho nút bị vô hiệu hóa */
            cursor: not-allowed;
            /* Con trỏ không cho nút bị vô hiệu hóa */
        }
    </style>
    <link rel="stylesheet" href="../css/nhapchiso.css">
...
if (isset($_GET['mahd'])) {
    ...
    if ($show_hd_add) { ?>
        <table border="1">
            ...
            <tr>
                ...
                ?>
                <!-- <td><?php if ($show_hd_add['tinhtrang'] == 0) {
                    echo 'Chưa thanh toán [Giấy báo điện]';
                } else {
                    echo 'Đã thanh toán [Hóa đơn]';
                } ?></td>
                      <td><?php if ($show_hd_add['tinhtrang'] == 0) {
                          echo '<a href="../controller/tiendien.php?act=in&mahd=' . $show_hd_add['mahd'] . '">In giấy báo</a>';
                      } else {
                          echo '<a href="../controller/tiendien.php?act=in&mahd=' . $show_hd_add['mahd'] . '">In hóa đơn</a>';
                      } ?> </td>
                      <td><?php if ($show_hd_add['tinhtrang'] == 0) {
                          echo '<a name="hoanthanh"  href="../controller/tiendien.php?act=tinhdien&action=dathanhtoan&code=' . $show_hd_add['mahd'] . '">Đã thanh toán</a>';
                      } else {
                          echo 'Đã thanh toán !!!';
                      } ?></td> -->
            </tr>
    ...
    ?>
        ...
        <h2>Form tính tiền điện <i class="fa-solid fa-bolt"></i></h2>
        <?php
